...
const SkillItem =({ modalText, svgCode, viewBox, skillName, iconColor }: any) =>{
    ...
    return (
        <div className='group'>
            ...
            />
            <div onClick={modalSkill} className="group-hover:bg-slate-900 border-slate-700 group-hover:scale-105 cursor-pointer block py-2 text-center bg-slate-800 rounded flex items-center justify-center">
